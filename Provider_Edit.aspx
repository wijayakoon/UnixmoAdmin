<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Provider_New.aspx.cs" Inherits="Neemo.Provider_New" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Provider_Edit.aspx.cs" Inherits="NeemoAdmin.Provider_Edit" %>
   ...
   <link rel="stylesheet" href="/Admin/css/jquery-ui.css" id="theme"/>
    ...
    <script type="text/javascript">
        function ChangeDefault(id) {
            $.ajax({
                type: "POST",
                url: "Provider_New.aspx/Isdefault",
    ...
    <table align="left"  style="vertical-align:top; width: 1183px;">
       ...
       <tr>
            ...
            <td bgcolor="#EFEFEF" class="style7">
                ...
                <asp:TextBox ID="txt_ProviderNo" runat="server" Width="443px" MaxLength="100"></asp:TextBox>
        ...
        <tr valign="top">
            <td class="style4" bgcolor="#EFEFEF">
                Key words<asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM Provider WHERE (ProviderID = @ProviderID)">
                    <SelectParameters>
                        <asp:QueryStringParameter DefaultValue="1" Name="ProviderID" 
                            QueryStringField="ProviderID" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
            <td bgcolor="#EFEFEF">
           ...
           <td>
                ...
                <table style="width:100%;">
                    <tr>
                        <td class="style6">
                            ...
                            <h2>ProviderTypes</h2><br />
                           
                       <asp:DropDownList ID="drp_ProviderTypes" runat="server" 
                    Height="20px" Width="460px">
                </asp:DropDownList>
               
                
                <asp:Button ID="btn_ProviderTypeAdd" runat="server" Height="20px" Text="Add" 
                                        onclick="btn_ProviderTypeAdd_Click" ValidationGroup="ProviderType" />
                            <br />
                        </td>
                    </tr>
                    ...
                    <tr valign=top>
                        <td>
                            <asp:Label ID="lbl_ProviderTypeExists" runat="server" ForeColor="Red" 
                                style="font-weight: 700" Text="ProviderType already added to the List" 
                                Visible="False"></asp:Label>
                        </td>
                        <tr valign"=top">
                            <td valign="top">
                                <asp:GridView ID="grv_ProviderTypeList" runat="server" AutoGenerateColumns="False" 
                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                                    CellPadding="3" ForeColor="Black" GridLines="Vertical" 
                                    OnRowCancelingEdit="CancelEditProviderProviderType" OnRowEditing="EditProviderProviderType" 
                                    OnRowUpdating="UpdateProviderProviderType" Width="613px">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ProviderTypeID" Visible="false">
                                            <EditItemTemplate>
                                                <asp:Label ID="lbl_ProviderTypeIDEdit" runat="server" 
                                                    Text='<%# Eval("ProviderTypeID") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ProviderTypeID" runat="server" Text='<%# Eval("ProviderTypeID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Provider ProviderType ID" Visible="false">
                                            <EditItemTemplate>
                                                <asp:Label ID="lbl_ProviderProviderTypeidEdit" runat="server" 
                                                    Text='<%# Eval("ProviderProviderTypeid") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ProviderProviderTypeid" runat="server" 
                                                    Text='<%# Eval("ProviderProviderTypeid") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="ProviderType Name" Visible="true">
                                            <EditItemTemplate>
                                                <asp:Label ID="lbl_ProviderTypeNameEdit" runat="server" 
                                                    Text='<%# Eval("ProviderType") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ProviderTypeName" runat="server" Text='<%# Eval("ProviderType") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Active">
                                            <EditItemTemplate>
                                                <asp:CheckBox ID="chkActive_ProviderTypeEdit" runat="server" 
                                                    Checked='<%# Eval("active") %>' />
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkActive_ProviderType" runat="server" 
                                                    Checked='<%# Eval("active") %>' Enabled="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="EffectiveFromDate" Visible="False">
                                            <EditItemTemplate>
                                                <asp:Label ID="lbl_ProviderProviderTypeFromDate_Edit" runat="server" 
                                                    Text='<%# Eval("EffectiveFrom") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ProviderProviderTypeFromDate" runat="server" 
                                                    Text='<%# Eval("EffectiveFrom") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="EffectiveToDate" Visible="False">
                                            <EditItemTemplate>
                                                <asp:Label ID="lbl_TomDate_ProviderProviderTypeEdit" runat="server" 
                                                    Text='<%# Eval("EffectiveDateTo") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_TomDateProviderProviderType" runat="server" 
                                                    Text='<%# Eval("EffectiveDateTo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
            ...
            <br />
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:GridView ID="grv_ServiceTypes" runat="server" AutoGenerateColumns="False" 
                                BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                                CellPadding="3" ForeColor="Black" GridLines="Vertical" 
                                OnRowCancelingEdit="CancelEditProvider" OnRowEditing="EditProvider" 
                                OnRowUpdating="UpdateProvider" Width="613px">
                                <AlternatingRowStyle BackColor="#CCCCCC" />
                                <Columns>
                                      <asp:TemplateField>
       <EditItemTemplate>
       ...
       <ItemTemplate>
          <asp:LinkButton ID="lnkEdit" runat="server" CommandName="Edit" Text="Edit"></asp:LinkButton>
                                    ...
                                    <asp:TemplateField HeaderText="PriceID" Visible="false">
                                        <EditItemTemplate>
                                            <asp:Label ID="lbl_PriceidEdit" runat="server" Text='<%# Eval("Providerpriceid") %>'></asp:Label>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_Priceid" runat="server" 
                                                Text='<%# Eval("Providerpriceid") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                font-family: Arial, Helvetica, sans-serif" Text='<%# Eval("price","{0:N2}") %>' 
                                    ...
                                    <asp:TemplateField HeaderText="Active">
                                        <EditItemTemplate>
                                            <asp:CheckBox ID="chkActive_ProviderPriceEdit" runat="server" 
                                                Checked='<%# Eval("Active") %>' />
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkActive_ProviderPrice" runat="server" Checked='<%# Eval("Active") %>' 
                                                Enabled="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="EffectiveFromDate">
                                        <EditItemTemplate>
                                            <asp:Label ID="lbl_FromDate_ProviderPrieEdit" runat="server" Text='<%# Eval("EffectiveDateFrom") %>'></asp:Label>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_FromDate_ProviderPrie" runat="server" Text='<%# Eval("EffectiveDateFrom") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="EffectiveToDate">
                                        <EditItemTemplate>
                                            <asp:Label ID="lbl_TomDate_ProviderPrieEdit" runat="server" Text='<%# Eval("EffectiveDateTo") %>'></asp:Label>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_TomDate_ProviderPrie" runat="server" Text='<%# Eval("EffectiveDateTo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <FooterStyle BackColor="#CCCCCC" />
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="lbl_NoPriceWarning" runat="server" 
                            style="color: #990000; font-weight: 700" Text="Please Add Price to This Provider" 
                            Visible="False"></asp:Label>
                        <br />
