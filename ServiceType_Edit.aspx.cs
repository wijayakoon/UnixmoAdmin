    ...
    public partial class ServiceType_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ServiceTypeID", Convert.ToInt16(Request.QueryString["ServiceTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@ServiceType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[ServiceType_Update]";
