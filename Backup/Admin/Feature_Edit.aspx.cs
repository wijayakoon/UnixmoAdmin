...
{
    public partial class Feature_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@FeatureID", Convert.ToInt16(Request.QueryString["FeatureID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Feature", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Feature_Update]";
