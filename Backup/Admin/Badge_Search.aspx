<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Badge_Search.aspx.cs" Inherits="Neemo.Admin.Badge_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="BadgeID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="BadgeID" HeaderText="BadgeID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="BadgeID" />
                                <asp:BoundField DataField="Badge" HeaderText="Badge" 
                                    SortExpression="Badge" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT BadgeID,Badge,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Badge ORDER BY [Badge]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
