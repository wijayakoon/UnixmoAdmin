...
{
    public partial class Colour_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ColourID", Convert.ToInt16(Request.QueryString["ColourID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Colour", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Colour_Update]";
