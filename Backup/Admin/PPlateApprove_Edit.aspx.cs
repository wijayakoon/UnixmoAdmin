...
{
    public partial class PPlateApprove_Edit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                foreach (DataRowView rowView in dv)
                {
                    ...
                    Image_Icon.ImageUrl = ConfigurationManager.AppSettings["LookupIcons_Display"].ToString() + (string)row["Image"];
        ...
        {
            Response.Redirect("PPlateApprove_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@PPlateApproveID", Convert.ToInt16(Request.QueryString["PPlateApproveID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@PPlateApprove", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[PPlateApprove_Update]";
