<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CCRating_Search.aspx.cs" Inherits="Neemo.Admin.CCRating_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="CCRatingID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="CCRatingID" HeaderText="CCRatingID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="CCRatingID" />
                                <asp:BoundField DataField="CCRating" HeaderText="CCRating" 
                                    SortExpression="CCRating" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT CCRatingID,CCRating,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM CCRating ORDER BY [CCRating]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
