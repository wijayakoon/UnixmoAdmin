...
{
    public partial class DealType_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("DealType_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@DealTypeID", Convert.ToInt16(Request.QueryString["DealTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@DealType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[DealType_Update]";
