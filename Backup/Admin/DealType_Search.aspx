<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DealType_Search.aspx.cs" Inherits="Neemo.Admin.DealType_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="DealTypeID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="DealTypeID" HeaderText="DealTypeID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="DealTypeID" />
                                <asp:BoundField DataField="DealType" HeaderText="DealType" 
                                    SortExpression="DealType" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT DealTypeID,DealType,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM DealType ORDER BY [DealType]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
