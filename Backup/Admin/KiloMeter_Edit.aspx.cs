...
{
    public partial class KiloMeter_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("KiloMeter_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@KiloMeterID", Convert.ToInt16(Request.QueryString["KiloMeterID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@KiloMeter", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[KiloMeter_Update]";
