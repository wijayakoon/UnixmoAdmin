<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Induction_Search.aspx.cs" Inherits="Neemo.Admin.Induction_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="InductionID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="InductionID" HeaderText="InductionID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="InductionID" />
                                <asp:BoundField DataField="Induction" HeaderText="Induction" 
                                    SortExpression="Induction" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT InductionID,Induction,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Induction ORDER BY [Induction]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
