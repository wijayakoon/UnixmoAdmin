...
{
    public partial class Price_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Price_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@PriceID", Convert.ToInt16(Request.QueryString["PriceID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Price", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Price_Update]";
