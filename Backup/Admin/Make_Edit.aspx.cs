...
{
    public partial class Make_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@MakeID", Convert.ToInt16(Request.QueryString["MakeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Make", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Make_Update]";
