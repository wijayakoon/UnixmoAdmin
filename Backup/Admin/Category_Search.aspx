<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category_Search.aspx.cs" Inherits="Neemo.Admin.Category_Search" %>
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT CategoryID,Category,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Category ORDER BY [Category]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
