<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PPlateApprove_Edit.aspx.cs" Inherits="Neemo.Admin.PPlateApprove_Edit" %>
        ...
        <tr>
            ...
            <td align="center" colspan="2" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="UPDATE P-PLATE APPROVAL RATING"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;</td>
            <td class="style2" bgcolor="#EFEFEF">
                PPlateApprove Name<asp:RequiredFieldValidator 
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT PPlateApproveID,PPlateApprove,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [PPlateApprove] WHERE ([PPlateApproveID] = @PPlateApproveID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="PPlateApproveID" QueryStringField="PPlateApproveID" 
                            DefaultValue="1" />
                    </SelectParameters>
