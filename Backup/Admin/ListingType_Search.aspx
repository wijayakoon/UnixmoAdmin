<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListingType_Search.aspx.cs" Inherits="Neemo.Admin.ListingType_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="ListingTypeID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="ListingTypeID" HeaderText="ListingTypeID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="ListingTypeID" />
                                <asp:BoundField DataField="ListingType" HeaderText="ListingType" 
                                    SortExpression="ListingType" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT ListingTypeID,ListingType,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM ListingType ORDER BY [ListingType]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
