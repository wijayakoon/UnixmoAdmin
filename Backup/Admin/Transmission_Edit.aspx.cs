...
{
    public partial class Transmission_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Transmission_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@TransmissionID", Convert.ToInt16(Request.QueryString["TransmissionID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Transmission", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Transmission_Update]";
