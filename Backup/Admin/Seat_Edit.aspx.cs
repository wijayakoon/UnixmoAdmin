...
{
    public partial class Seat_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Seat_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@SeatID", Convert.ToInt16(Request.QueryString["SeatID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Seat", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Seat_Update]";
