...
namespace Neemo.Admin
{
    public partial class Category_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Category_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@CategoryID", Convert.ToInt16(Request.QueryString["CategoryID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Category", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Category_Update]";
