...
{
    public partial class Condition_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ConditionID", Convert.ToInt16(Request.QueryString["ConditionID"].ToString()));
                ...
                sqlCmd.CommandText = "[Condition_Update]";
