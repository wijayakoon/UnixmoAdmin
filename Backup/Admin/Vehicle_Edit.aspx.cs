...
namespace Neemo.Admin
{
    public partial class Vehicle_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Vehicle_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@VehicleID", Convert.ToInt16(Request.QueryString["VehicleID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Vehicle", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Vehicle_Update]";
