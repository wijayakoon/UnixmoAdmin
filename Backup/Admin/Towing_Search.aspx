<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Towing_Search.aspx.cs" Inherits="Neemo.Admin.Towing_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="TowingID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="TowingID" HeaderText="TowingID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="TowingID" />
                                <asp:BoundField DataField="Towing" HeaderText="Towing" 
                                    SortExpression="Towing" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT TowingID,Towing,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Towing ORDER BY [Towing]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
