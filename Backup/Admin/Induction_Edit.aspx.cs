...
{
    public partial class Induction_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Induction_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@InductionID", Convert.ToInt16(Request.QueryString["InductionID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Induction", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Induction_Update]";
