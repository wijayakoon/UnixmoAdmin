...
{
    public partial class WheelBase_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@WheelBaseID", Convert.ToInt16(Request.QueryString["WheelBaseID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@WheelBase", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[WheelBase_Update]";
