...
{
    public partial class Model_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ModelID", Convert.ToInt16(Request.QueryString["ModelID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Model", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Model_Update]";
