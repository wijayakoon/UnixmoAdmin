...
{
    public partial class BodyType_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@BodyTypeID", Convert.ToInt16(Request.QueryString["BodyTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@BodyType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[BodyType_Update]";
