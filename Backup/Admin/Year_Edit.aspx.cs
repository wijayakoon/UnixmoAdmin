...
{
    public partial class Year_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Year_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@YearID", Convert.ToInt16(Request.QueryString["YearID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Year", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Year_Update]";
