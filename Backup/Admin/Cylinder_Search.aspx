<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Cylinder_Search.aspx.cs" Inherits="Neemo.Admin.Cylinder_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="CylinderID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="CylinderID" HeaderText="CylinderID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="CylinderID" />
                                <asp:BoundField DataField="Cylinder" HeaderText="Cylinder" 
                                    SortExpression="Cylinder" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT CylinderID,Cylinder,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Cylinder ORDER BY [Cylinder]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
