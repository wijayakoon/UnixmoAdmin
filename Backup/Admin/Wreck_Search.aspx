<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Wreck_Search.aspx.cs" Inherits="Neemo.Admin.Wreck_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="WreckID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="WreckID" HeaderText="WreckID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="WreckID" />
                                <asp:BoundField DataField="WreckNo" HeaderText="Wreck No" 
                                    SortExpression="WreckNo" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT WreckID,WreckNo,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Wreck ORDER BY [WreckNo]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
