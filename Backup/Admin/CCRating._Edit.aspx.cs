...
{
    public partial class CCRating_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("CCRating_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@CCRatingID", Convert.ToInt16(Request.QueryString["CCRatingID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@CCRating", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[CCRating_Update]";
