...
{
    public partial class Cylinder_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Cylinder_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@CylinderID", Convert.ToInt16(Request.QueryString["CylinderID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Cylinder", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Cylinder_Update]";
