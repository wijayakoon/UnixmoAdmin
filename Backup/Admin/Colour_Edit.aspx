<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Colour_Edit.aspx.cs" Inherits="Neemo.Admin.Colour_Edit" %>
        ...
        <tr>
            ...
            <td align="center" colspan="2" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="UPDATE COLOUR"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;</td>
            <td class="style2" bgcolor="#EFEFEF">
                Colour Name<asp:RequiredFieldValidator 
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT ColourID,Colour,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [Colour] WHERE ([ColourID] = @ColourID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="ColourID" QueryStringField="ColourID" 
                            DefaultValue="1" />
                    </SelectParameters>
