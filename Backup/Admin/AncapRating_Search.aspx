<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AncapRating_Search.aspx.cs" Inherits="Neemo.Admin.AncapRating_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="AncapRatingID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="AncapRatingID" HeaderText="AncapRatingID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="AncapRatingID" />
                                <asp:BoundField DataField="AncapRating" HeaderText="AncapRating" 
                                    SortExpression="AncapRating" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT AncapRatingID,AncapRating,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM AncapRating ORDER BY [AncapRating]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
