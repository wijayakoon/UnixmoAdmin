...
{
    public partial class ListingType_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("ListingType_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ListingTypeID", Convert.ToInt16(Request.QueryString["ListingTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@ListingType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[ListingType_Update]";
