<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DriveType_Edit.aspx.cs" Inherits="Neemo.Admin.DriveType_Edit" %>
        ...
        <tr>
            ...
            <td align="center" colspan="2" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="UPDATE DRIVE TYPE RATING"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;</td>
            <td class="style2" bgcolor="#EFEFEF">
                DriveType Name<asp:RequiredFieldValidator 
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT DriveTypeID,DriveType,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [DriveType] WHERE ([DriveTypeID] = @DriveTypeID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="DriveTypeID" QueryStringField="DriveTypeID" 
                            DefaultValue="1" />
                    </SelectParameters>
