...
{
    public partial class Door_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Door_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@DoorID", Convert.ToInt16(Request.QueryString["DoorID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Door", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Door_Update]";
