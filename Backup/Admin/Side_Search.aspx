<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Side_Search.aspx.cs" Inherits="Neemo.Admin.Side_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="SideID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="SideID" HeaderText="SideID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="SideID" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT SideID,Side,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM Side ORDER BY [Side]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
