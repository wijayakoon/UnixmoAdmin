<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Induction_Edit.aspx.cs" Inherits="Neemo.Admin.Induction_Edit" %>
        ...
        <tr>
            ...
            <td align="center" colspan="2" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="UPDATE INDUCTION RATING"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;</td>
            <td class="style2" bgcolor="#EFEFEF">
                Induction Name<asp:RequiredFieldValidator 
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT InductionID,Induction,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [Induction] WHERE ([InductionID] = @InductionID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="InductionID" QueryStringField="InductionID" 
                            DefaultValue="1" />
                    </SelectParameters>
