<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="KiloMeter_New.aspx.cs" Inherits="Neemo.Admin.KiloMeter_New" %>
        ...
        <tr>
            ...
            <td align="center" colspan="2" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="ADD KILOMETERES RATING"></asp:Label>
            </td>
        </tr>
        <tr>
