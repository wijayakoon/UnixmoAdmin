...
{
    public partial class Engine_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@EngineID", Convert.ToInt16(Request.QueryString["EngineID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@EngineNo", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Engine_Update]";
