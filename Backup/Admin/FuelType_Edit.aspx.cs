...
{
    public partial class FuelType_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@FuelTypeID", Convert.ToInt16(Request.QueryString["FuelTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@FuelType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[FuelType_Update]";
