...
{
    public partial class Towing_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Towing_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@TowingID", Convert.ToInt16(Request.QueryString["TowingID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Towing", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Towing_Update]";
