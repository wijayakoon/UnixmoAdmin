<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="State_Edit.aspx.cs" Inherits="Neemo.Admin.State_Edit" %>
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT StateID,State,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [State] WHERE ([StateID] = @StateID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="StateID" QueryStringField="StateID" 
                            DefaultValue="1" />
                    </SelectParameters>
