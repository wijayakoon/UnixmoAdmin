...
{
    public partial class Side_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@SideID", Convert.ToInt16(Request.QueryString["SideID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Side", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Side_Update]";
