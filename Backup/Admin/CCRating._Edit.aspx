<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CCRating._Edit.aspx.cs" Inherits="Neemo.Admin.CCRating_Edit" %>
    ...
    <table align="left"  style="vertical-align:top;border=0">
        ...
        <tr>
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;</td>
            <td class="style2" bgcolor="#EFEFEF">
                CCRating Name<asp:RequiredFieldValidator 
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT CCRatingID,CCRating,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [CCRating] WHERE ([CCRatingID] = @CCRatingID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="CCRatingID" QueryStringField="CCRatingID" 
                            DefaultValue="1" />
                    </SelectParameters>
