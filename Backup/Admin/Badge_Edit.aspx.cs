...
{
    public partial class Badge_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@BadgeID", Convert.ToInt16(Request.QueryString["BadgeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Badge", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Badge_Update]";
