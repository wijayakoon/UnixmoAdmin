...
namespace Neemo.Admin
{
    public partial class Power_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Power_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@PowerID", Convert.ToInt16(Request.QueryString["PowerID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Power", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Power_Update]";
