...
{
    public partial class Suburb_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Suburb_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@SuburbID", Convert.ToInt16(Request.QueryString["SuburbID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Suburb", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Suburb_Update]";
