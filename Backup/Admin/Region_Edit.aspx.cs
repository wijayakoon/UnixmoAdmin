...
{
    public partial class Region_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Region_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@RegionID", Convert.ToInt16(Request.QueryString["RegionID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Region", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Region_Update]";
