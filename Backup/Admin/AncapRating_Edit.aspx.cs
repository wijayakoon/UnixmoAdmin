...
{
    public partial class AncapRating_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("AncapRating_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@AncapRatingID", Convert.ToInt16(Request.QueryString["AncapRatingID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@AncapRating", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[AncapRating_Update]";
