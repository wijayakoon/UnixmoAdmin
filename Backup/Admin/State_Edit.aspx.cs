...
{
    public partial class State_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("State_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@StateID", Convert.ToInt16(Request.QueryString["StateID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@State", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[State_Update]";
