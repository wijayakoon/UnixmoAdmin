...
{
    public partial class DriveType_Edit : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("DriveType_New.aspx");
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@DriveTypeID", Convert.ToInt16(Request.QueryString["DriveTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@DriveType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[DriveType_Update]";
