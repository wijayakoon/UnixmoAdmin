...
{
    public partial class Series_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@SeriesID", Convert.ToInt16(Request.QueryString["SeriesID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@Series", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Series_Update]";
