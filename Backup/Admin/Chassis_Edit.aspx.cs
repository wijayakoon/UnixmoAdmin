...
{
    public partial class Chassis_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ChassisID", Convert.ToInt16(Request.QueryString["ChassisID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@ChassisNo", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[Chassis_Update]";
