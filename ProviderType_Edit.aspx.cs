...
{
    public partial class ProviderType_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@ProviderTypeID", Convert.ToInt16(Request.QueryString["ProviderTypeID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@ProviderType", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[ProviderType_Update]";
