...
{
    public partial class DisplayOrder_Edit : System.Web.UI.Page
    {
        ...
        private void saverec()
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.AddWithValue("@DisplayOrderID", Convert.ToInt16(Request.QueryString["DisplayOrderID"].ToString()));
                sqlCmd.Parameters.AddWithValue("@DisplayOrder", TextBox_Name.Text);
                ...
                sqlCmd.CommandText = "[DisplayOrder_Update]";
