<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Product_Update.aspx.cs" Inherits="NeemoAdmin.Product_Update" %>
   ...
   <link rel="stylesheet" href="/Admin/css/jquery-ui.css" id="theme"/>
    ...
    <table align="left"  style="vertical-align:top; width: 51%;">
        <tr>
            <td align="center" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="UPDATE PRODUCTS"></asp:Label>
                <asp:SqlDataSource ID="SqlDataSourceProduct" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [vw_productAll] WHERE ([ProductId] = @ProductId)">
                    <SelectParameters>
        ...
        <table style="width: 51%;">
            ...
            <tr>
                ...
                <td bgcolor="#EFEFEF" class="style20">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drp_Wreck" ErrorMessage="Wreck Required" InitialValue="0" ForeColor="#CC3300" ValidationGroup="save">*</asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td bgcolor="#EFEFEF" class="style20">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="drp_Part" ErrorMessage="Part Required" InitialValue="0" ForeColor="#CC3300" ValidationGroup="save">*</asp:RequiredFieldValidator>
        ...
        <asp:MultiView ID="mvw_Parts" runat="server">
            ...
            <asp:View ID="vw_PartDetails_All" runat="server">
                <h2>
                    Part Details</h2>
               <%-- <asp:ListView ID="lv_Parts" runat="server" DataSourceID="sqlParts">
                    <ItemTemplate>--%>
                        <table width="725px" style="border: thin solid #808080;">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_Category" runat="server" Width="500px"></asp:TextBox>    <%--  <%# Eval("Category")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_PartNo" runat="server" Width="500px"></asp:TextBox> <%-- <%# Eval("PartNo")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_Part" runat="server" Width="500px"></asp:TextBox><%-- <%# Eval("Part")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_PartShortDescription" runat="server" Width="500px"></asp:TextBox><%-- <%# Eval("ShortDescription")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_PartDescription" runat="server" Height="66px" TextMode="MultiLine" Width="500px"></asp:TextBox> <%-- <%# Eval("Description")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_Height" runat="server" Width="500px"></asp:TextBox>  <%--<%# Eval("Height")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                   <asp:TextBox ID="txt_Width" runat="server" Width="500px"></asp:TextBox><%-- <%# Eval("Width")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                   <asp:TextBox ID="txt_Length" runat="server" Width="500px"></asp:TextBox><%-- <%# Eval("Length")%>--%>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    Weight</td>
                                <td>
                                    <asp:TextBox ID="txt_Weight" runat="server" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Colour </td>
                                <td>
                                    <asp:TextBox ID="txt_Colour" runat="server" Width="500px"></asp:TextBox>
                                    <%--<%# Eval("Weight")%>--%></td>
                            </tr>
                            <tr>
                                <td>Side </td>
                                <td>
                                    <asp:TextBox ID="txt_Side" runat="server" Width="500px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:CheckBox ID="chk_PartActive" runat="server" /><%-- Checked='<%# Eval("Active") %>' />--%>
                                </td>
                            </tr>
                        </table>
                    <%--</ItemTemplate>
                ...
                <asp:SqlDataSource ID="sqlParts" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    SelectCommand="Select * from vw_PartDetails_All P
    ...
    <ContentTemplate>
            ...
            <tr>
                <td bgcolor="#EFEFEF" class="style13">
                    &nbsp;Featured</td>
                <td bgcolor="#EFEFEF" class="style21">
                    <asp:CheckBox ID="chk_Featured" runat="server" Checked='<%# Eval("Featured") %>' />
                </td>
                <td bgcolor="#EFEFEF" class="style14">
