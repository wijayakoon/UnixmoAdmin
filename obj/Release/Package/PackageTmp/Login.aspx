...
<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NeemoAdmin.Login" %>


<%@ Register src="~/ProcessingInProgressPanel.ascx" tagname="ProcessingInProgressPanel" tagprefix="uc1" %>
<%@ Register src="~/UC_Login.ascx" tagname="UC_Login" tagprefix="uc2" %>
