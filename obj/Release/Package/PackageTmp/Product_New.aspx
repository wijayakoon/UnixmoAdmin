...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Product_New.aspx.cs" Inherits="NeemoAdmin.Product_New" %>
        ...
        <table style="width: 51%;">
            ...
            <tr>
                ...
                <td bgcolor="#EFEFEF" class="style20">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drp_Wreck" ErrorMessage="Wreck Required" InitialValue="0" ForeColor="#CC3300" ValidationGroup="save">*</asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td bgcolor="#EFEFEF" class="style20">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="drp_Part" ErrorMessage="Part Required" InitialValue="0" ForeColor="#CC3300" ValidationGroup="save">*</asp:RequiredFieldValidator>
