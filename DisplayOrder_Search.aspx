<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DisplayOrder_Search.aspx.cs" Inherits="NeemoAdmin.DisplayOrder_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="DisplayOrderID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="DisplayOrderID" HeaderText="DisplayOrderID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="DisplayOrderID" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT DisplayOrderID,DisplayOrder,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM DisplayOrder ORDER BY [DisplayOrder]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
