<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ProviderType_Search.aspx.cs" Inherits="NeemoAdmin.ProviderType_Search" %>
         ...
         <tr>
            ...
            <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            CellPadding="4" DataKeyNames="ProviderTypeID" DataSourceID="SqlDataSource1" 
                            ForeColor="#333333" GridLines="None" onrowcommand="GridView_RowCommand" 
                            Width="1026px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" />
                                <asp:BoundField DataField="ProviderTypeID" HeaderText="ProviderTypeID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="ProviderTypeID" />
                                <asp:BoundField DataField="ProviderType" HeaderText="ProviderType" 
                                    SortExpression="ProviderType" />
        ...
        <tr>
            <td class="style4">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT ProviderTypeID,ProviderType,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime FROM ProviderType ORDER BY [ProviderType]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
