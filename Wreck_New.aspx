<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="Wreck_New.aspx.cs" Inherits="NeemoAdmin.Wreck_New" EnableEventValidation="true" %>

<%@ Register Src="~/ProcessingInProgressPanel.ascx" TagName="ProcessingInProgressPanel"
    TagPrefix="uc1" %>
        ...
        <ContentTemplate>
            <table align="left" style="vertical-align: top; width: 828px;">
                ...
                <tr>
                    ...
                    <td bgcolor="#EFEFEF">
                        <asp:TextBox ID="txt_WreckNo" runat="server" MaxLength="50" Width="350px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_Make0" runat="server" ControlToValidate="txt_WreckNo" ErrorMessage="Wreck No Required" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                    </td>
                    <td bgcolor="#EFEFEF">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td bgcolor="#EFEFEF">
                        <asp:TextBox ID="txt_KeyWord" runat="server" MaxLength="50" Width="350px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_Model1" runat="server" ControlToValidate="txt_KeyWord" ErrorMessage="Key Word Required" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                    </td>
                    <td bgcolor="#EFEFEF">
                        &nbsp;
                    </td>
