<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DisplayOrder_Edit.aspx.cs" Inherits="NeemoAdmin.DisplayOrder_Edit" %>
        ...
        <tr>
            ...
            <td align="center" colspan="2" bgcolor="#CCCCCC">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="#000066" 
                    style="font-size: large" Text="UPDATE DisplayOrder"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;</td>
            <td class="style2" bgcolor="#EFEFEF">
                DisplayOrder Name<asp:RequiredFieldValidator 
        ...
        <tr>
            ...
            <td class="style2" bgcolor="#EFEFEF">
                &nbsp;<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT DisplayOrderID,DisplayOrder,Active,Image,EffectiveDateFrom,EffectiveDateTo,CreatedDateTime,DeletedDateTime  FROM [DisplayOrder] WHERE ([DisplayOrderID] = @DisplayOrderID)">
                    <SelectParameters>
                        <asp:QueryStringParameter Name="DisplayOrderID" QueryStringField="DisplayOrderID" 
                            DefaultValue="1" />
                    </SelectParameters>
